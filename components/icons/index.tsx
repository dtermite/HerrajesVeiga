...
// This is a barrel file to export all icons. For simplicity in this project structure, 
// I am defining them all in one file. In a larger project, each would be a separate file.
...
export const ChevronLeftIcon: React.FC<IconProps> = ({ className, size=32 }) => (
...
export const ChevronRightIcon: React.FC<IconProps> = ({ className, size=32 }) => (
